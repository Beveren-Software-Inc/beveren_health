frappe.ui.form.on("Cost Center", {
	...
	refresh: function (frm) {
		...
		if (frm.doc.custom_address) {
			frm.fields_dict["custom_address_display"].$wrapper.html(
				frm.doc.custom_address_display || ""
			);
		}
	},

	custom_address: function (frm) {
		erpnext.utils.get_address_display(frm, "custom_address", "custom_address_display", false);
	},
});
