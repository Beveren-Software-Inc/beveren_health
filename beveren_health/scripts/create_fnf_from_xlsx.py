...
FNF_DATA = [
	{
		"fnf_id": "HR-FNF-2026-00028",
		"employee": "S059",
		"transaction_date": "2026-06-08",
		"date_of_joining": "2022-07-28",
		"relieving_date": "2026-06-07",
		"base_salary": 190,
		"basic_salary": 101,
		"nationality": "Egyptian",
		"is_gosi": False,
		"department": "Security - SPH",
		"designation": "Security",
		"payables": [
			{"label": "May salary", "amount": 190, "type": "salary"},
			{"label": "7 days of June salary", "amount": 44.333, "type": "salary"},
			{
				"label": "Indemnity Reward (Before Cut-Off Date)",
				"amount": 149.404,
				"type": "indemnity_before",
			},
	...
	{
		"fnf_id": "HR-FNF-2026-00027",
		"employee": "S091",
		"transaction_date": "2026-06-01",
		"date_of_joining": "2024-10-27",
		"relieving_date": "2026-06-03",
		"base_salary": 400,
		"basic_salary": 370,
		"nationality": "Pakistani",
		"is_gosi": False,
		"department": "Human Resource - SPH",
		"designation": "HR Manager",
		"payables": [
			{"label": "3 days of june", "amount": 39.999, "type": "salary"},
			{
				"label": "indeminity from 27 october 2024 to 30 April 2025",
				"amount": 92.983,
				"type": "indemnity_before",
			},
	...
	{
		"fnf_id": "HR-FNF-2026-00026",
		"employee": "S081",
		"transaction_date": "2026-05-25",
		"date_of_joining": "2025-12-06",
		"relieving_date": "2026-03-31",
		"base_salary": 1000,
		"basic_salary": 700,
		"nationality": "Pakistani",
		"is_gosi": False,
		"department": "Account - SPH",
	...
	{
		"fnf_id": "HR-FNF-2026-00025",
		"employee": "S010",
		"transaction_date": "2026-05-13",
		"date_of_joining": "2026-02-15",
		"relieving_date": "2026-05-14",
		"base_salary": 750,
		"basic_salary": 750,
		"nationality": "Bahraini",
		"is_gosi": True,
		"department": "Admin - SPH",
		"designation": None,
		"payables": [
	...
	{
		"fnf_id": "HR-FNF-2026-00024",
		"employee": "S114",
		"transaction_date": "2026-05-10",
		"date_of_joining": "2025-03-23",
		"relieving_date": "2026-04-15",
		"base_salary": 400,
		"basic_salary": 250,
		"nationality": "Philippine",
		"is_gosi": False,
		"department": "Nursing - SPH",
		"designation": "Nurse",
		"payables": [
	...
	{
		"fnf_id": "HR-FNF-2026-00023",
		"employee": "S037",
		"transaction_date": "2026-04-17",
		"date_of_joining": "2022-04-25",
		"relieving_date": "2026-03-25",
		"base_salary": 200,
		"basic_salary": 100,
		"nationality": "Egyptian",
		"is_gosi": False,
		"department": "Transport - SPH",
		"designation": "Driver",
		"payables": [
	...
	{
		"fnf_id": "HR-FNF-2026-00022",
		"employee": "S071",
		"transaction_date": "2026-04-17",
		"date_of_joining": "2024-10-03",
		"relieving_date": "2026-04-11",
		"base_salary": 180,
		"basic_salary": 100,
		"nationality": "Indian",
		"is_gosi": False,
		"department": "House Keeping - SPH",
		"designation": "Cleaner",
		"payables": [
	...
	{
		"fnf_id": "HR-FNF-2026-00021",
		"employee": "S008",
		"transaction_date": "2026-04-19",
		"date_of_joining": "2022-05-25",
		"relieving_date": "2026-04-08",
		"base_salary": 180,
		"basic_salary": 100,
		"nationality": "Egyptian",
		"is_gosi": False,
	...
	{
		"fnf_id": "HR-FNF-2026-00018",
		"employee": "S009",
		"transaction_date": "2026-04-19",
		"date_of_joining": "2017-07-14",
		"relieving_date": "2026-04-08",
		"base_salary": 230,
		"basic_salary": 109.5,
	...
	{
		"fnf_id": "HR-FNF-2026-00017",
		"employee": "S007",
		"transaction_date": "2026-04-18",
		"date_of_joining": "2022-05-16",
		"relieving_date": "2026-04-04",
		"base_salary": 200,
		"basic_salary": 100,
		"nationality": "Kenyan",
		"is_gosi": False,
	...
	{
		"fnf_id": "HR-FNF-2026-00015",
		"employee": "S006",
		"transaction_date": "2026-04-18",
		"date_of_joining": "2022-09-18",
		"relieving_date": "2026-04-08",
		"base_salary": 450,
		"basic_salary": 450,
		"nationality": "Bahraini",
	...
	{
		"fnf_id": "HR-FNF-2026-00010",
		"employee": "S110",
		"transaction_date": "2026-04-09",
		"date_of_joining": "2025-07-17",
		"relieving_date": "2026-04-02",
		"base_salary": 210,
		"basic_salary": 100,
		"nationality": "Uganda",
		"is_gosi": False,
	...
	{
		"fnf_id": "HR-FNF-2026-00009",
		"employee": "S109",
		"transaction_date": "2026-04-10",
		"date_of_joining": "2025-05-04",
		"relieving_date": "2026-04-08",
		"base_salary": 180,
		"basic_salary": 100,
		"nationality": "Uganda",
...
def _ensure_employee(data):
	...
	if nationality:
		meta_field = frappe.get_meta("Employee").get_field("custom_nationality") or frappe.get_meta(
			"Employee"
		).get_field("nationality")
		if meta_field:
	...
	_log(
		f"  + Employee {code} created ({data.get('designation')}, left {data['relieving_date']}) "
...
def _create_leave_encashment(employee, amount, posting_date, label, company=COMPANY):
	...
	if flt(amount) == 0:
		return None, None
	as_name = _create_additional_salary(employee, "Leave Encashment", amount, posting_date, label, company)
...
def _process_fnf(data):
	...
	for p in data["payables"]:
		...
		if t in ("indemnity_before", "indemnity_after", "indemnity_placeholder"):
			...
			as_name = (
				_create_additional_salary(employee, "Bonus", abs(amt), payroll_date, label) if amt else None
			)
			payable_rows.append(
				_build_payable_row(
					label,
			...
			receivable_rows.append(
				_build_payable_row(
					...
					account=frappe.db.get_value(
						"Account", {"company": COMPANY, "account_name": "Employee Advances"}, "name"
					)
	...
	existing_fnf = frappe.db.get_value(
	...
	_log(
		f"  ✓ FnF {fnf.name} created for {employee} with {len(payable_rows)} payables, {len(receivable_rows)} receivables"
	)
	return fnf.name
