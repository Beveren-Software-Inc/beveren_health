...
from frappe.utils.data import format_time, get_link_to_form
...
class LessTimeEntry(Document):
	...
	def calculate_less_time_amount(
		self, less_time_type, applicable_hourly_rate, less_time_duration, less_time_date
	):
		...
		if self.total_less_time_duration:
			less_time_duration = (
				less_time_duration * self.total_less_time_duration / self.total_less_time_duration_1
			)
