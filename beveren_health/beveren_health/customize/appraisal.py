	...
	def set_kras_and_rating_criteria(self):
		...
		for entry in template.goals:
			row_data = {
				...
				"custom_minimum_requirement_out_of_100": entry.get("custom_minimum_requirement_out_of_100")
				or 0,
			}
		...
		for entry in template.rating_criteria:
			self.append(
				"self_ratings",
				{
					...
					"per_weightage": entry.per_weightage,
					"custom_minimum_requirement_out_of_100": entry.get(
						"custom_minimum_requirement_out_of_100"
					)
					or 0,
				},
			)
